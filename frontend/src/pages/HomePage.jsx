...
const FeatureCard = ({ icon: Icon, title, description, gradient, i }) => {
  ...
  return (
    <motion.div
      ...
      className="relative glass-card rounded-2xl p-6 group overflow-hidden border border-white/5 bg-[#0a0f18]/60 hover:bg-[#0d131f]/80 backdrop-blur-md transition-all duration-500 hover:-translate-y-1 hover:shadow-xl"
    >
      ...
      <div className="relative mb-5 inline-block z-10">
        ...
        <div className="relative size-12 rounded-xl flex items-center justify-center bg-[#1e232d]/80 border border-white/5 shadow-lg backdrop-blur-md group-hover:scale-110 transition-transform duration-500">
          <div className={`absolute inset-0 rounded-xl bg-gradient-to-br ${gradient} opacity-20`} />
          <Icon className="size-5 text-white relative z-10 drop-shadow-md" strokeWidth={1.5} />
        </div>
      </div>
      <h3 className="font-bold text-base mb-2 text-base-content z-10 relative">{title}</h3>
      <p className="text-sm text-base-content/55 leading-relaxed z-10 relative">{description}</p>
    </motion.div>
  );
};
    ...
    <div className="min-h-screen hero-bg overflow-x-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 group cursor-pointer">
            ...
            <div className="flex items-baseline" style={{ fontFamily: "'Outfit', sans-serif" }}>
              ...
              <span className="text-2xl font-light text-base-content tracking-wider">
                Verse
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <SignInButton mode="modal">
              <button className="btn-gradient flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold shine-on-hover">
                Get Started Free
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-20">
        ...
        <div className="text-center max-w-4xl mx-auto animate-slide-up relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-16 animate-slide-up-2">
            <SignInButton mode="modal">
              <button className="btn-gradient flex items-center gap-2.5 px-8 py-4 rounded-2xl text-base font-bold shine-on-hover text-white">
            ...
            <button className="flex items-center gap-2.5 px-8 py-4 rounded-2xl text-base font-semibold border border-base-content/10 bg-base-content/5 hover:bg-base-content/10 transition-colors text-base-content/80">
      ...
      <section id="testimonials" className="relative max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-14">
          ...
          <p className="text-base-content/50">Real feedback from real interviews</p>
        </div>
          ...
          {testimonials.map(({ name, role, stars, text }, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                <div className="size-9 rounded-full bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center text-white text-sm font-bold">
                  {name[0]}
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="size-8 rounded-lg bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center">
                <SparklesIcon className="size-4 text-white" />
              </div>
              <span className="font-bold text-lg gradient-text">InterviewVerse</span>
            </div>
          ...
          <div>
            <h4 className="font-bold mb-4 text-base-content/80">Product</h4>
            <div className="flex flex-col gap-2 text-sm text-base-content/50">
              <a href="#features" className="hover:text-base-content transition-colors">Features</a>
              <a href="#testimonials" className="hover:text-base-content transition-colors">Testimonials</a>
            </div>
          </div>
          <div>
            <h4 className="font-bold mb-4 text-base-content/80">Subscribe</h4>
            <p className="text-xs text-base-content/50 mb-3">Get the latest updates and interview tips.</p>
            <div className="flex items-center gap-2">
              <input type="email" placeholder="Enter your email" className="input input-sm input-bordered bg-base-100/50 w-full" />
